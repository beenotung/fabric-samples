...
.. code:: bash
  ...
  CORE_PEER_ADDRESS=peer:7051 CORE_CHAINCODE_ID_NAME=mycc:0 ./data-sharing
...
.. code:: bash
  ...
  peer chaincode install -p chaincodedev/chaincode/data-sharing -n mycc -v 0
...
By default, we mount only ``data-sharing``.  However, you can easily test different
